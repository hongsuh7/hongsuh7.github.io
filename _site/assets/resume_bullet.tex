...
\noindent {\it Tools/Packages:} PyTorch, scikit-learn, NumPy, CuPy, Pandas, tidyverse, plotly, caret, Google Colab
...
\begin{itemize}
  ...
  \begin{itemize}
    \item Developed a new high-performance neural network architecture for image classification and generation, modifying the methodology in recent normalizing flow papers.
    ...
    \item {\it Technologies.} PyTorch, R.
  \end{itemize}
  ...
  \begin{itemize}
    ...
    \item {\it Technologies.} Python, CuPy, plotly.
  \end{itemize}
  ...
  \item[$\square$] {\bf PhD research on stochastic homogenization for an exclusion process.}  
  \begin{itemize}
  ...
  \item[$\square$] {\bf Undergraduate research on fringe pairs in generalized MSTD sets.} 
  \begin{itemize}
...
\begin{itemize}
  \item Created and executed daily 2-hour lesson plans covering advanced math subjects---such as university-level linear algebra, number theory, and discrete probability---to kids who love math.
\end{itemize}
